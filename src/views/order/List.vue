...
<template>
  <div class="container mt-4">
    ...
    <router-link to="/order" class="btn btn-primary mb-4"
      > Order Create</router-link
    >
      <div v-if="order.length === 0" class="alert alert-danger d-flex align-items-center" role="alert">
    ...
    <button class="btn btn-success m-4" @click="reset">reset</button> 
    {{store.name}}
    {{store.doubleCount}}
    {{store.status}}
  </div>
